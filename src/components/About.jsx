const About = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-950 via-purple-700 to-pink-400 relative overflow-hidden">
      {/* Decorative Blobs */}
      ...
      <section className="relative bg-white bg-opacity-95 text-gray-800 py-16 px-8 md:px-20 rounded-3xl shadow-2xl max-w-6xl w-full mx-4 flex flex-col md:flex-row items-center gap-14 z-10">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-xl mb-6 leading-relaxed">
            Hello! I’m <span className="font-semibold text-blue-800">Sanduni Lasara</span>, a passionate developer dedicated to building beautiful and functional web applications.
          </p>
        ...
        <div className="flex-1 flex justify-center">
          <div className="relative group">
            <img
              ...
              alt="Sanduni Lasara"
              className="rounded-full mx-auto mb-4 w-80 h-80 shadow-lg border-purple-300 transition-transform duration-300 transform group-hover:scale-105"
            />
